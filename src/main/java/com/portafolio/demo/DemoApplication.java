...
//		registry.addMapping("/**").allowedOrigins("https://dry-escarpment-06809.herokuapp.com","http://localhost:4200")
...
//		config.getCorsRegistry().addMapping("/**").allowedOrigins("https://dry-escarpment-06809.herokuapp.com","http://localhost:4200")
//				.allowedMethods("PUT", "DELETE","POST","GET")
//				.allowedHeaders("application/json", "text/plain", "application/x-www-form-urlencoded")
//				.allowCredentials(false).maxAge(3600);
//	}
